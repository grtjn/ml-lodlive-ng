# Contributing to ml-lodlive-ng

ml-lodlive-ng welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-lodlive-ng, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **ml-lodlive-ng Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/ml-lodlive-ng/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-lodlive-ng.git
$ cd ml-lodlive-ng
$ git remote add upstream git://github.com/grtjn/ml-lodlive-ng.git
```
...
Go to https://github.com/username/ml-lodlive-ng and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-lodlive-ng/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-lodlive-ng/issues
