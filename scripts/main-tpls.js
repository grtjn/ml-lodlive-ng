...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/quickstart.html',
    '<h1 class="page-header">Quickstart</h1><div class="row"><div class="col-md-12"><p>To start using Google Maps for MarkLogic, follow these simple steps to get started.</p><ol class="steps"><li><p>Download <a href="https://raw.github.com/grtjn/ml-lodlive-ng/master/dist/ml-lodlive-ng.js">ml-lodlive-ng.js</a> (<a href="https://raw.github.com/grtjn/ml-lodlive-ng/master/dist/ml-lodlive-ng.min.js">minified version</a>) and put it with your other scripts. Alternatively, you can use Bower to install it automatically:</p><div hljs="" language="bash">bower install [--save] ml-lodlive-ng</div><p>Or if you prefer bleeding edge:</p><div hljs="" language="bash">bower install [--save] git@github.com:grtjn/ml-lodlive-ng.git</div><p>If not using Bower, you\'ll also need to fetch <a href="https://github.com/angular-ui/ui-utils/tree/v0.2.3" rel="external">ui-utils.js (v0.2.3)</a>, and <a href="https://github.com/angular-ui/ui-map/tree/v0.5.0" rel="external">ui-map.js (v0.5.0)</a> yourself.</p></li><li><p>Load ui-utils.js, ui-map.js, and ml-lodlive-ng.js into your HTML page (typically in the end of the <em>BODY</em> of your HTML):</p><pre hljs="" language="html">\n' +
